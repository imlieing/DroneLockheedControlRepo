...
using namespace std;
namespace autonomous = autonomous_control;
...
autonomous::Autonomous::autonomous(void) : n(), n_private("autonomous_control"), key_override_enabled(false), joy_override_enabled(false)
{
